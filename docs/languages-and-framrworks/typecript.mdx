...
3.  **Avoid `any` type :**<Tag color="volcano">Safety</Tag> <Tag color="cyan"> Readability</Tag><br />
...
4.  **Interfaces Over Inline Types:**<Tag color="volcano">Safety</Tag> <br />
...
5.  **Use `readonly`:**<Tag color="volcano">Safety</Tag> <br />
...
6.  **Consistent Naming Conventions:** <Tag color="cyan">Readability</Tag> <br />
...
9. **Use Union and Intersection Types:**
...
11. **Avoid Type Assertion for Unknown Types:**
